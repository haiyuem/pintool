...
//
// A working snapshot of the program that is written only for insns appearing in lane detection (and specific ATL_spNBmm_b1 kernel)
//
...
const string ins_str
    ...
    if ((opcode == XED_ICLASS_ADDPS) || (opcode == XED_ICLASS_IMUL) || (opcode == XED_ICLASS_MULPS)) return 0x7;
...
int main(int argc, char* argv[])
{
    ...
    OutFile.open("write_out_trace_lane_det_ATL_spNBmm_b1.out");
    ByteFile.open("trace_lane_det_ATL_spNBmm_b1");
